                        ...
                        <div class="portlet light ">
                            <div class="portlet-title">
                                <div class="caption caption-md">
                                    <span class="caption-subject  bold uppercase">My Posts</span>
                                </div>
                            </div>
        ...
        <li class="list-group-item panel-body">
            <table class="table-padding">
                ...
                <tr>
                    ...
                    <td><a href="{{ url('/my-blog/showall')}}">Show All</a></td>
                    @endif
                </tr>
                <tr>
                    ...
                    <td><a href="{{ url('/my-blog/my-posts')}}">Show All</a></td>
                    @endif
                </tr>
                <tr>
                    ...
                    <td><a href="{{ url('/my-blog/my-drafts')}}">Show All</a></td>
                    @endif
                </tr>
            </table>
        </li>
