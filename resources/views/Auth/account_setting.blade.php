...
<div class="content">
    ...
    <div class="row">
        ...
        @include('partials.profile_side_bar')
                                    ...
                                    <form role="form" action="{{url('/update-pesonal-info')}}" method="POST" id="personal-info-form">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="username" placeholder="username" class="form-control"
                                                value="{{(!old('username')) ? Auth::user()->username : old('username')}}" 
                                                > 
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="email" name="email" placeholder="email" class="form-control"
                                                value="{{(!old('email')) ? Auth::user()->email : old('email')}}" 
                                                >
                                            <span class="help-block">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="first_name" placeholder="Enter First Name" class="form-control"
                                                value="{{(!old('first_name')) ? Auth::user()->first_name : old('first_name')}}" 
                                                > 
                                            <span class="help-block">
                                        ...
                                        <div class="form-group">
                                            ...
                                            value="{{(!old('last_name')) ? Auth::user()->last_name : old('last_name')}}" 
                                            >
                                            <span class="help-block">
                                        ...
                                        <div class="form-group">
                                            ...
                                            value="{{(!old('mobile_number')) ? Auth::user()->mobile_number : old('mobile_number')}}"  
                                            >
                                            <span class="help-block">
                                        ...
                                        <div class="form-group">
                                            ...
                                            value="{{!old('interest') ? Auth::user()->interest : old('interest')}}" 
                                            >
                                            <span class="help-block">
                                        ...
                                        <div class="form-group">
                                            ...
                                            value="{{(!old('occupation')) ? Auth::user()->occupation : old('occupation')}}" 
                                            >
                                            <span class="help-block">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name= "about" class="form-control" rows="3" style="margin: 0px -1px 0px 0px; width: 905px; height: 99px;">
                                                {{(!old('about')) ? Auth::user()->about : old('about')}} 
                                        ...
                                        <div class="form-group">
                                            ...
                                            value="{{(!old('online_portfolio')) ? Auth::user()->online_portfolio : old('online_portfolio')}}"
                                            >
                                            <span class="help-block">
                                        ...
                                        <div class="form-group">
                                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                                <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                                    <img src="{{url('/get_user_images')}}" alt=""> 
                                                </div>
