...
<style type="text/css">
    ...
    height: 100%;
                ...
                <section class="content-header">
                  <h1>
                    Dashboard <!-- galing sa route -->
                    <small>Notifications of retrieved data</small>
                  </h1>
                  <ol class="breadcrumb">
                        ...
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge">
                                        <span data-counter="counterup" data-value="{{$req_count}}">0</span>
                                    </div>
...
var chart = AmCharts.makeChart( "chart_1", {
            ...
            var chart2 = AmCharts.makeChart( "pie-chart", {
                "type": "pie",
                "titles": [ {
